                    ...
                    if (data) {
                        ...
                        if (code == "0") {
                            ...
                            for (var index in xlList) {
                                ...
                                if (rq == currDate) {
                                    if (rqDay == "01") {
                                        rqDay = '<p style="background-color: #076cec;line-height: 30px;width: 90%;color: #fff">' + wpt_xl.getMyMonth(rqS[1]) + '</p>';
                                    } else {
                                        rqDay = '<p style="background-color: #076cec;line-height: 30px;width: 90%;color: #fff">' + rqDay + '</p>';
                                    }

                                } else if (rqDay == "01") {
                                    rqDay = '<p style="color:#1E9FFF">' + wpt_xl.getMyMonth(rqS[1]) + '</p>';
                                }
