...
<div class="ccj">
    <div class="titledddiv">
        ...
        <p class="titleName">综合评分查询</p>
    </div>

    <div class="titleccj" style="height: 76px" id="ttt">
        <img class="img" src="<%=Constant.server_name%>img/ccd-zhpfcx.png"/>
...
<script src="<%=Constant.server_name%>module/fwzx/xg/zhpfcx/js/zhpfcx.js" charset="utf-8"></script>
</body>
</html>
