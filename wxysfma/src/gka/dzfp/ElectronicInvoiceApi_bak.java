 ...
 * 电子发票API
 */
public class ElectronicInvoiceApi_bak {
    //服务地址
//    private final static String dzfp_domian = "http://112.49.34.4:18001/colleges-proxy/api/college/";
     ...
     * @desc 单张票据开具接口
     */
    public static void invoiceEBillByCollege(String sendObj, FpglBean fpglBean) {
        JSONObject requestBody = eleUtil.genRequestBody_bak(sendObj);
