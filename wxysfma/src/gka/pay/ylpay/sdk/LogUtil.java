...
public class LogUtil {
    ...
    private final static Logger GATELOG = LogManager.getLogger("ACP_SDK_LOG");
    private final static Logger GATELOG_ERROR = LogManager.getLogger("SDK_ERR_LOG");
    private final static Logger GATELOG_MESSAGE = LogManager.getLogger("SDK_MSG_LOG");
