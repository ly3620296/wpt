...
public class WxPayDao {
    ...
    public void insertOrderYl(WxPayOrder wxPayOrder, String val) {
        ...
        Db.update(sql, wxPayOrder.getXh(), wxPayOrder.getOut_trade_no(), wxPayOrder.getIds(), wxPayOrder.getPay_type(), String.valueOf(Double.parseDouble(wxPayOrder.getTotal_fee()) / 100),
