...
<div class="layui-form-item" style="margin-top: 3%;">
    <div class="layui-inline">
        ...
        <div class="layui-input-block">
            <input type="text" id="title" name="xm" placeholder="请输入员工姓名" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-inline">
...
<script>
    ...
    layui.use(['form', 'laypage', 'layer', 'table', 'element', 'slider', 'jquery'], function () {
        ...
        table.render({
            ...
            , cols: [[   //表头
                ...
                , {field: 'XM', title: '员工姓名'}
                , {field: 'DH', title: '员工电话'}
                , {field: 'XYXM', title: '所属学院'}
                , {fixed: 'right', title: '操作', align: 'center', toolbar: '#barDemo'}
            ]]
            , url: wpt_serverName + 'ygtxl/list' //数据接口地址
            , title: '用户表'
            , page: true //开启分页
    ...
    function edit(id) {
        layer.open({
            ...
            title: '编辑通讯录',
            area: ['70%', '68%'], //宽高
            content: '/wptma/module/ygtxl/edit.jsp?id=' + id,  //调到新增页面
    ...
    function func7() {
        layer.open({
            ...
            title: '添加通讯录',
            area: ['70%', '90%'], //宽高
            content: '/wptma/module/ygtxl/add.jsp',  //调到新增页面
            success: function (layero, index) {
                // 新iframe窗口的对象
                var iframeWin = layero.find('iframe')[0].contentWindow;
                // 重新渲染checkbox,select同理
    ...
    function closeAll() {
        layer.closeAll();
        window.location.href = wpt_serverName + '/module/ygtxl/list.jsp';
    }

    function del(array) {
        $.ajax({
            url: wpt_serverName + "ygtxl/del",
            type: 'post',
            dataType: 'json',
            data: {id: array},
            timeout: 10000,
