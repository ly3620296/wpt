            ...
            <form method="post">
                <ul>
                    ...
                    <li>
                        ...
                        <img  class="image" id="mobileImage" src="" onclick="updateCaptcha();" style="width: 40%;margin-left: 10px"/>
...
<script type="text/javascript" src="<%=Constant.server_name%>js-lib/wptma/login.js"></script>
</html>