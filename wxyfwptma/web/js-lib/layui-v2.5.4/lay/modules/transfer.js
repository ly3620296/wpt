...
;
layui.define(["laytpl", "form", "jquery", "layer"], function (e) {
    "use strict";
    ...
    x.prototype.config = {
        ...
        e.elem.on("click", 'input[lay-filter="layTransferCheckbox"]+', function () {
            ...
            if (!n.hasClass(o)) {
                ...
                if (i == 0) {
                    var toto = e.config.value.length + a('input[type="checkbox"][value^="SFXM"]:checked').length;
                    if (toto > 3) {
                        layer.alert("至多配置三项收费项目", {icon: 2});
                        return;
                    }
                }
