...
public class WxPayTool {
     ...
     * @throws Exception
     */
    public Map[] unifiedOrderNATIVE(WxPayBean wxPayBean) throws Exception {
        Map[] mapArr = new Map[2];
        Map<String, String> map = new HashMap<String, String>();
        map.put("body", PayConstant.BODY);
        map.put("out_trade_no", wxPayBean.getOrderNo());
    ...
    public Map<String, String> reqData(Map<String, String> result) {
        ...
        try {
            ...
            String sign = WXPayUtil.generateSignature(reqData, ProKit.use("gkean.properties").getStr("apiKey"), WXPayConstants.SignType.HMACSHA256);
